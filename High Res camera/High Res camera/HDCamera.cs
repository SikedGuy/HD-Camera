    ...
    public class HDCamera : MelonMod
    {
        ...
        private void ApplyToHeldCamera()
        {
            ...
            {                
                ...
                l.targetTexture = new RenderTexture((int)imageSize, (int)imageSize, 0, RenderTextureFormat.ARGB32);
            ...
            else if (r != null)
            {
                ...
                r.targetTexture = new RenderTexture((int)imageSize, (int)imageSize, 0);
