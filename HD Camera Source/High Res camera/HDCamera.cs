...
namespace HD_Camera
{
    public class HDCamera : MelonMod
    {
        ...
        private void ApplyToHeldCamera()
        {
            ...
            if (l != null)
            {                
                toplevelL.Find("Variables/width").GetComponent<EventSystem>().m_DragThreshold = (int)imageSize; // dont know why this works
                l.targetTexture.Release(); //Enum: R8G8B8A8_UNORM
                l.targetTexture.width = (int)imageSize;
                l.targetTexture.height = (int)imageSize;
                //l.targetTexture = new RenderTexture((int)imageSize, (int)imageSize, 0, RenderTextureFormat.ARGB64); // makes the screen turn black
            ...
            else if (r != null)
            {
                ...
                r.targetTexture.width = (int)imageSize;
                r.targetTexture.height = (int)imageSize;
